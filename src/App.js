...
class App extends Component {
	...
	render () {
		...
		return (
			<div className='App'><h1 className='App-title'>Subscripción</h1>
					{!this.state.subscriptionState ? (<form><ValidatorForm >
									<Button variant={!subscriptionType?'contained':'outlined'} color='primary' onClick={this.changeVariant}>Free </Button>{'  '}
